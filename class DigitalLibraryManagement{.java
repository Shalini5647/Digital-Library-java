...
class DigitalLibraryManagement{
    ...
    {
        map.put(1,"Java : Head First Java");
        map.put(2,"Java : The Complete Reference");
        map.put(3,"Java : An Integrated Approach");
        map.put(4,"Python : Python Crash Course");
        map.put(5,"Python : Head-First Python");
        map.put(6,"Python : Think Python");
        map.put(7,"C++: C++ Primer");
        map.put(8,"C++: A Tour of C++");
        map.put(9,"C++ : Accelerated C++");
        map.put(10,"C : The C Programming Language");
        map.put(11,"C : Head First C");
        map.put(12,"C : C Programming");
        ...
        map.put(18,"C : Data Structures Using C");
        map.put(19,"C : C The Complete reference");
        map.put(20," : Economics for Engineers");
    ...
    public void user_login()
    {
        ...
        System.out.print("Enter Password: ");
        int password = sc.nextInt();
        loginto.put("Shalu",654321);
        loginto.put("Cheeku",456789);
        loginto.put("Sivi",68970);
